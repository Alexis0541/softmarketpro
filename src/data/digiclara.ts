...
export const articles = defs.flatMap(([slug, topic, group, tags, sources, esTitle, enTitle, esSummary, enSummary, esAlt, enAlt, featured], index) => [
  {
    ...
    updated: '2026-07-16',
    image: `/assets/images/articles/${slug}.svg`,
    imageCredit: 'Ilustración original de DigiClara, creada para este artículo.',
    featured,
    title: esTitle,
    summary: esSummary,
  ...
  },
  {
    ...
    updated: '2026-07-16',
    image: `/assets/images/articles/${slug}.svg`,
    imageCredit: 'Original DigiClara illustration created for this article.',
    featured,
    title: enTitle,
    summary: enSummary,
