...
const sourceSets = {
  ...
  mfaMethods: [
    { label: 'NIST SP 800-63B-4 - Authentication and Authenticator Management', url: 'https://pages.nist.gov/800-63-4/sp800-63b.html' },
    { label: 'CISA - Implementing Phishing-Resistant MFA', url: 'https://www.cisa.gov/sites/default/files/publications/fact-sheet-implementing-phishing-resistant-mfa-508c.pdf' },
    { label: 'Microsoft Learn - Protecting authentication methods', url: 'https://learn.microsoft.com/en-us/entra/identity/authentication/concept-authentication-default-enablement' },
    { label: 'Google Account Help - Sign in with a passkey', url: 'https://support.google.com/accounts/answer/13548313' },
  ],
  software: [
...
const defs = [
  ...
  ['passkeys-vs-contrasenas', 'security', 'comparisons', ['Passkeys', 'Contraseñas', 'FIDO'], sourceSets.mfaMethods, 'Passkeys frente a contraseñas: ventajas, límites y recuperación', 'Passkeys vs passwords: benefits, limits and recovery', 'Comparativa práctica entre contraseñas, passkeys sincronizadas, llaves físicas y recuperación de cuenta.', 'A practical comparison of passwords, synced passkeys, hardware keys and account recovery.', 'Llaves de seguridad usadas para autenticación multifactor.', 'Security keys used for multi-factor authentication.', false],
  ['fatiga-mfa-push-bombing', 'security', 'guides', ['MFA', 'Push bombing', 'Autenticación'], sourceSets.mfaMethods, 'Qué es la fatiga de MFA o push bombing', 'What MFA fatigue or push bombing is', 'Cómo funcionan las solicitudes repetidas de autenticación, qué señales mirar y cómo reducir aprobaciones accidentales.', 'How repeated authentication prompts work, which signs to watch for and how to reduce accidental approvals.', 'Varios teléfonos usados como referencia para autenticación móvil.', 'Several phones used as a reference for mobile authentication.', false],
  ['comparar-metodos-mfa', 'security', 'comparisons', ['MFA', 'SMS', 'Passkeys', 'Llave física'], sourceSets.mfaMethods, 'Aplicación autenticadora, SMS, passkey o llave física: qué método elegir', 'Authenticator app, SMS, passkey or hardware key: which method to choose', 'Criterios para elegir segundo factor según riesgo, comodidad, recuperación y resistencia al phishing.', 'Criteria for choosing a second factor by risk, convenience, recovery and phishing resistance.', 'Llave de seguridad usada como segundo factor de autenticación.', 'Security key used as a second authentication factor.', false],
] as const;
